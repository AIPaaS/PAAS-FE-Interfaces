...
public class CPcAppImage implements Condition {
	...
	/**
	 * condition-field: 容器名[CONTAINER_NAME] operate-Like[like] 如果做为服务需与服务名保持一致
	 */
	...
	/**
	 * condition-field: CPU个数[CPU_COUNT] operate-Equal[=] 单位：0.00
	 */
	private Integer cpuCount;

	/**
	 * condition-field: CPU个数[CPU_COUNT] operate-In[in] 单位：0.00
	 */
	private Integer[] cpuCounts;

	/**
	 * condition-field: CPU个数[CPU_COUNT] operate-GTEqual[>=] 单位：0.00
	 */
	private Integer startCpuCount;

	/**
	 * condition-field: CPU个数[CPU_COUNT] operate-LTEqual[<=] 单位：0.00
	 */
	private Integer endCpuCount;

	/**
	 * condition-field: 内存大小[MEM_SIZE] operate-Equal[=] 单位：M
	 */
	private Long memSize;

	/**
	 * condition-field: 内存大小[MEM_SIZE] operate-In[in] 单位：M
	 */
	private Long[] memSizes;

	/**
	 * condition-field: 内存大小[MEM_SIZE] operate-GTEqual[>=] 单位：M
	 */
	private Long startMemSize;

	/**
	 * condition-field: 内存大小[MEM_SIZE] operate-LTEqual[<=] 单位：M
	 */
	private Long endMemSize;

	/**
	 * condition-field: 存储大小[DISK_SIZE] operate-Equal[=] 单位：M
	 */
	private Long diskSize;

	/**
	 * condition-field: 存储大小[DISK_SIZE] operate-In[in] 单位：M
	 */
	private Long[] diskSizes;

	/**
	 * condition-field: 存储大小[DISK_SIZE] operate-GTEqual[>=] 单位：M
	 */
	private Long startDiskSize;

	/**
	 * condition-field: 存储大小[DISK_SIZE] operate-LTEqual[<=] 单位：M
	 */
	...
	/**
	 * condition-field: 是否自动伸缩[IS_SUPPORT_FLEX] operate-Equal[=] 1=是 0=否
	 */
	private Integer isSupportFlex;

	/**
	 * condition-field: 是否自动伸缩[IS_SUPPORT_FLEX] operate-In[in] 1=是 0=否
	 */
	private Integer[] isSupportFlexs;

	/**
	 * condition-field: 是否自动伸缩[IS_SUPPORT_FLEX] operate-GTEqual[>=] 1=是 0=否
	 */
	private Integer startIsSupportFlex;

	/**
	 * condition-field: 是否自动伸缩[IS_SUPPORT_FLEX] operate-LTEqual[<=] 1=是 0=否
	 */
	...
	/**
	 * condition-field: 容器伸缩CPU上限值[CPU_FLEX_UPPER_LIMIT] operate-In[in] 单位：0.00
	 */
	...
	/**
	 * condition-field: 容器伸缩CPU下限值[CPU_FLEX_LOWER_LIMIT] operate-In[in] 单位：0.00
	 */
	...
	/**
	 * condition-field: 是否均匀分布[IS_UNIFORM] operate-Equal[=] 1=是 0=否
	 */
	private Integer isUniform;

	/**
	 * condition-field: 是否均匀分布[IS_UNIFORM] operate-In[in] 1=是 0=否
	 */
	private Integer[] isUniforms;

	/**
	 * condition-field: 是否均匀分布[IS_UNIFORM] operate-GTEqual[>=] 1=是 0=否
	 */
	private Integer startIsUniform;

	/**
	 * condition-field: 是否均匀分布[IS_UNIFORM] operate-LTEqual[<=] 1=是 0=否
	 */
	private Integer endIsUniform;

	/**
	 * condition-field: 容器标签[TARGS] operate-Like[like] JSON {key:value}
	 */
	private String targs;

	/**
	 * condition-field: 操作步骤[SETUP_NUM] operate-Equal[=] 1=容器定义 2=开放服务 3=依赖服务
	 * 4=其它参数 9=完成
	 */
	private Integer setupNum;

	/**
	 * condition-field: 操作步骤[SETUP_NUM] operate-In[in] 1=容器定义 2=开放服务 3=依赖服务
	 * 4=其它参数 9=完成
	 */
	private Integer[] setupNums;

	/**
	 * condition-field: 操作步骤[SETUP_NUM] operate-GTEqual[>=] 1=容器定义 2=开放服务 3=依赖服务
	 * 4=其它参数 9=完成
	 */
	private Integer startSetupNum;

	/**
	 * condition-field: 操作步骤[SETUP_NUM] operate-LTEqual[<=] 1=容器定义 2=开放服务 3=依赖服务
	 * 4=其它参数 9=完成
	 */
	private Integer endSetupNum;

	/**
	 * condition-field: 定时开始时间[TIMER_START_TIME] operate-Equal[=] 定时容器字段
	 */
	private Long timerStartTime;

	/**
	 * condition-field: 定时开始时间[TIMER_START_TIME] operate-In[in] 定时容器字段
	 */
	private Long[] timerStartTimes;

	/**
	 * condition-field: 定时开始时间[TIMER_START_TIME] operate-GTEqual[>=] 定时容器字段
	 */
	private Long startTimerStartTime;

	/**
	 * condition-field: 定时开始时间[TIMER_START_TIME] operate-LTEqual[<=] 定时容器字段
	 */
	private Long endTimerStartTime;

	/**
	 * condition-field: 定时结束时间[TIMER_END_TIME] operate-Equal[=] 定时容器字段
	 */
	private Long timerEndTime;

	/**
	 * condition-field: 定时结束时间[TIMER_END_TIME] operate-In[in] 定时容器字段
	 */
	private Long[] timerEndTimes;

	/**
	 * condition-field: 定时结束时间[TIMER_END_TIME] operate-GTEqual[>=] 定时容器字段
	 */
	private Long startTimerEndTime;

	/**
	 * condition-field: 定时结束时间[TIMER_END_TIME] operate-LTEqual[<=] 定时容器字段
	 */
	private Long endTimerEndTime;

	/**
	 * condition-field: 定时器类型[TIMER_TYPE] operate-Equal[=] 定时容器字段 1=周期型 2=日历型
	 */
	private Integer timerType;

	/**
	 * condition-field: 定时器类型[TIMER_TYPE] operate-In[in] 定时容器字段 1=周期型 2=日历型
	 */
	private Integer[] timerTypes;

	/**
	 * condition-field: 定时器类型[TIMER_TYPE] operate-GTEqual[>=] 定时容器字段 1=周期型 2=日历型
	 */
	private Integer startTimerType;

	/**
	 * condition-field: 定时器类型[TIMER_TYPE] operate-LTEqual[<=] 定时容器字段 1=周期型 2=日历型
	 */
	private Integer endTimerType;

	/**
	 * condition-field: 定时表达式[TIMER_EXP] operate-Like[like] 定时容器字段
	 * 周期型：为间隔秒数；日历型：为CRON表达式
	 */
	private String timerExp;

	/**
	 * condition-field: 定时表达式[TIMER_EXP] operate-Equal[=] 定时容器字段
	 * 周期型：为间隔秒数；日历型：为CRON表达式
	 */
	private String timerExpEqual;

	/**
	 * condition-field: 定时表达式[TIMER_EXP] operate-In[in] 定时容器字段
	 * 周期型：为间隔秒数；日历型：为CRON表达式
	 */
	...
	/**
	 * condition-field: 数据状态[DATA_STATUS] operate-Equal[=] 数据状态：1-正常 0-删除
	 */
	private Integer dataStatus;

	/**
	 * condition-field: 数据状态[DATA_STATUS] operate-In[in] 数据状态：1-正常 0-删除
	 */
	private Integer[] dataStatuss;

	/**
	 * condition-field: 数据状态[DATA_STATUS] operate-GTEqual[>=] 数据状态：1-正常 0-删除
	 */
	private Integer startDataStatus;

	/**
	 * condition-field: 数据状态[DATA_STATUS] operate-LTEqual[<=] 数据状态：1-正常 0-删除
	 */
